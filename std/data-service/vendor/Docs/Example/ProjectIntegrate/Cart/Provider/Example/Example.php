...
class ExampleClient implements \Provider\Example\ExampleIf {
  ...
  {
    $args = new \Provider\Example\Example_sayHello_args();
    $args->name = $name;
  ...
  public function recv_sayHello()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Provider\Example\Example_sayHello_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Provider\Example\Example_sayHello_result();
...
class Example_sayHello_args {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Example_sayHello_args');
    if ($this->name !== null) {
...
class Example_sayHello_result {
  ...
  public function getName() {
    return 'Example_sayHello_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Example_sayHello_result');
