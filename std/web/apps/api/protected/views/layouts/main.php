...
<html>
  <head>
    ...
    <script>var staticUri='<?php echo Yii::app()->clientScript->getCoreScriptUrl(); ?>',token='<?php echo Yii::app()->Session->getSessionID(); ?>',uploadUri='http://my.com:8124/upload',customApp=[], apiUrl='http://<?php echo API_DOMAIN; ?>';</script>
    <?php if ($this->jsApp) : ?>
