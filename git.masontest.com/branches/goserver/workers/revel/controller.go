...
func (c *Controller) Render(data interface{}, err error) Result {
    errorCode   := 0
...
// key-value "user": (User).
func (c *Controller) OldRender(o ...interface{}) Result {
    if len(o) == 1 {
        return RenderJsonResult{o[0], ""}
    } else {
        result  := []interface{}{}
        for _, data := range o {
